<%@ Page Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="procedimentos.aspx.cs" Inherits="MedProj.www.adm.procedimentos.procedimentos" %>
                    ...
                    <div class="text-right col-md-12"></div>
                        ...
                        <asp:GridView ID="grid" runat="server" SkinID="gridPadraoProp" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <%--<asp:ButtonField ButtonType="Link" Text="" CommandName="Email" Visible="true">
                                    <ItemStyle Width="1%" />
                                    <ControlStyle CssClass="glyphicon glyphicon-envelope" />
                                </asp:ButtonField>--%>
