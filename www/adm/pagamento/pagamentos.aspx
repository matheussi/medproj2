<%@ Page Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="pagamentos.aspx.cs" Inherits="MedProj.www.adm.pagamento.pagamentos" %>
                    ...
                    <div class="text-right col-md-12"></div>
                        ...
                        <asp:GridView ID="grid" runat="server" SkinID="gridPadraoProp" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Tipo" HeaderStyle-Wrap="false" >
                                    <ItemTemplate>
                                        <asp:Literal ID="litTipo" Text='<%#DataBinder.Eval(Container.DataItem, "TipoPagto")%>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
