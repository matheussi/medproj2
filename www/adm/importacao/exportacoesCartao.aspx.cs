namespace MedProj.www.adm.importacao
{
    ...
    public partial class exportacoesCartao : System.Web.UI.Page
    {
        ...
        void localizar()
        {
            ...
            grid.DataSource = AgendaExportacaoCartaoFacade.Instancia.Carregar(de, ate, AgendaStatus.Indefinido);
            grid.DataBind();
        }

        protected void lnkNovo_Click(object sender, EventArgs e)
        {
            Response.Redirect("exportacaoCartao.aspx");
        }
        ...
        protected void grid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("Editar"))
            {
                ...
                Response.Redirect(string.Format("exportacaoCartao.aspx?{0}={1}", Util.Keys.IdKey, id));
            }
        ...
        protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                AgendaExportacaoCartao agenda = e.Row.DataItem as AgendaExportacaoCartao;
