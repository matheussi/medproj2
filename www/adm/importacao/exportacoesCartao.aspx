<%@ Page Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="exportacoesCartao.aspx.cs" Inherits="MedProj.www.adm.importacao.exportacoesCartao" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="title" runat="server">
    Agenda de Exportações - Cartão
</asp:Content>
                        ...
                        <asp:GridView ID="grid" runat="server" SkinID="gridPadraoProp" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Operadora" HeaderStyle-Wrap="false" >
                                    <ItemTemplate>
                                        <asp:Literal ID="litOperadora" Text='<%#DataBinder.Eval(Container.DataItem, "Operadora.Nome")%>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
