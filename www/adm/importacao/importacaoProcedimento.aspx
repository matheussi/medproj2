<%@ Page Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="importacaoProcedimento.aspx.cs" Inherits="MedProj.www.adm.importacao.importacaoProcedimento" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4"><asp:DropDownList ID="cboTabelaPreco" runat="server" Width="100%" MaxLength="10" SkinID="comboPadrao1" /></div>
                    </div>

                    <div class="form-group">
                        <label class="col-xs-2 control-label">Prestadores</label>
                        <div class="col-xs-5"><asp:DropDownList SkinID="comboPadrao1" Width="100%" runat="server" ID="cboPrestadores" AutoPostBack="true" OnSelectedIndexChanged="cboPrestadores_SelectedIndexChanged" /></div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-2 control-label">Contratos</label>
                        <div class="col-xs-5"><asp:DropDownList SkinID="comboPadrao1" Width="100%" runat="server" ID="cboContrato" AutoPostBack="false" /></div>
                        <div class="col-xs-1"><asp:Button ID="cmdAdd" Text="+" runat="server" SkinID="botaoPadraoINFO_Small" OnClick="cmdAdd_Click" /></div>
                        <div class="col-xs-1"><asp:LinkButton ID="cmdAddAll" ToolTip="adicionar todos" OnClick="cmdAddAll_Click" SkinID="botaoPadraoINFO_Small" CssClass="glyphicon glyphicon-download" runat="server" /></div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-5 col-xs-offset-2">
                            <asp:ListBox ID="lstContratosAdicionados" Width="100%" Height="55px" runat="server" />
                        </div>
                        <div class="col-xs-1"><asp:Button ID="cmdRemove" Text="-" runat="server" SkinID="botaoPadraoINFO_Small" OnClick="cmdRemove_Click" /></div>
                    </div>

                    <asp:Panel ID="pnlUpload" runat="server">
                        <div class="form-group">
                            <label class="col-xs-2 control-label">Arquivo Excel</label>
                            <%--<div class="col-xs-10">
                                <asp:FileUpload ID="fuArquivoXML" Width="100%" runat="server" />
                            </div>--%>
                            <div class="col-xs-8">
