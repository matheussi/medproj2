<%@ Page Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="false" CodeBehind="consultaAtendimento.aspx.cs" Inherits="MedProj.www.atendimento.consultaAtendimento" %>
                            ...
                            <div class="col-md-5" style="padding-left:0px;">
                                <%--<div class="input-group">
                                    ...
                                    <asp:DropDownList ID="cboFormaPagto" Width="100 %" SkinID="comboPadrao1" runat="server">
                                        ...
                                        <asp:ListItem Text="Pagamento em dinheiro" Value="0" />
                                    </asp:DropDownList>
                                </div>--%>
                            </div>
                        </div>
