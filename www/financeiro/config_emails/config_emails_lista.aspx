<%@ Page Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="config_emails_lista.aspx.cs" Inherits="MedProj.www.financeiro.config_emails.config_emails_lista" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-right" style="position:relative;">
                    ...
                    <div style="position:absolute; right:80px; top:-70px;"><asp:Button ID="lnkTextos" Text="Textos" runat="server" EnableViewState="false" SkinID="botaoPadraoWarning" OnClick="lnkTextos_Click"  /></div>
